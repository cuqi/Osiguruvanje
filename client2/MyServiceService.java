 ...
 * 
 */
@WebServiceClient(name = "MyServiceService", targetNamespace = "http://myservice/", wsdlLocation = "http://localhost:8000/myservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICESERVICE_QNAME = new QName("http://myservice/", "MyServiceService");
    ...
    public MyService getMyServicePort() {
        return super.getPort(new QName("http://myservice/", "MyServicePort"), MyService.class);
    }
    ...
    public MyService getMyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myservice/", "MyServicePort"), MyService.class, features);
    }
